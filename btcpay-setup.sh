...
Environment variables:
    ...
    BTCPAYGEN_DOCKER_IMAGE: Allows you to specify a custom docker image for the generator (Default: amboss/docker-compose-generator)
...
export ANVIL_FULLNODE=\"$ANVIL_FULLNODE\"
