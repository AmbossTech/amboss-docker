...
If (-not ($BTCPAYGEN_DOCKER_IMAGE)) { $BTCPAYGEN_DOCKER_IMAGE = "amboss/docker-compose-generator" }

If ($BTCPAYGEN_DOCKER_IMAGE -eq "amboss/docker-compose-generator:local"){
